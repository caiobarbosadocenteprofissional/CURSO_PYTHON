...
# total_geral_funcionarios = 
# total_colaboradores_administrativos +
# total_colaboradores_desenvolvimento
...
pontuacao_teste_pratico = input("Qual é pontuação do teste prática?")

print(f"Nome: {nome_colaborador_input},
      Idade: {idade_colaborador_input}, Pontuação: {pontuacao_teste_pratico}")